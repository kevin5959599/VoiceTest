...
public class Weather extends Activity implements View.OnClickListener,ConnectionCallbacks,OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initView();
            ...
            {
                updatecitycode = getConfig(Weather.this, "Config", "SaveText", "87878787");
                cityname = getConfig(Weather.this, "Config_2", "SaveText_2", "N/A");
                cityT_2.setText(cityname);
                getWeatherDatafromNet_2(updatecitycode);
                Log.d("111111", "代碼:" + updatecitycode);
                Log.d("222222", "城市:" + cityname);
            }
            if(updatecitycode!=getConfig(Weather.this, "Config","SaveText","87878787")&&updatecitycode!=null) {
                Log.d("555555","555555");
                setConfig(Weather.this,"Config","SaveText",updatecitycode);
                setConfig(Weather.this,"Config_2","SaveText_2",cityname);
                Log.d("666666","666666");
                Toast.makeText(Weather.this,updatecitycode,Toast.LENGTH_SHORT).show();
                getWeatherDatafromNet_2(updatecitycode);
                cityT_2.setText(cityname);
    ...
    public void onClick(View v){
        ...
        {
            Toast.makeText(Weather.this,"Test",Toast.LENGTH_SHORT);
            buildGoogleApiClient();
        }else if(v.getId()==R.id.title_city_update)
        {
            Toast.makeText(Weather.this,"Test_02",Toast.LENGTH_SHORT);
